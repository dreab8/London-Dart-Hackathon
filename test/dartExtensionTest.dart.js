...
function main() {
  ...
  group("parser", (function () {
    test("shoultReturnCorrectTheUrlList", (function () {
      ...
      var result = parser.getUrlsStartingWith(className);
      Expect.equals(("" + kind + " " + className + " , " + url), result.$index((0)));
    })
    );
    test("ShouldReturnAnEmptyListForNotMatchingSearch", (function () {
      var className = "yrer";
      var result = parser.getUrlsStartingWith(className);
